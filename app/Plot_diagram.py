...
def plot_graph(w_function, a, b, graph_name):
    ...
    fig = go.Figure(data=[go.Surface(z=z_axis,
                                     ...
                                     y=y_axis,
                                     colorscale='Viridis',
                                     colorbar_title_text=graph_name + f"(max: {z_axis.max():.2f})"
                                     )])
